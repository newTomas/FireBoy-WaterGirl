  ...
  repeat
    ...
    case inlobby of
      false: Begin
        ...
        if s1[0] = 'cords' then
        Begin
          players[1].img.Left := StrToInt(s1[1]);
          players[1].img.Top := StrToInt(s1[2]);
        End;
      End;
      true: Begin
        if s = 'start' then
